...
export const AI_TOOLS: ChatCompletionTool[] = [
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    imageUrl: {
                        type: 'string',
                        description: 'Image URL (use placeholder service like https://via.placeholder.com/WIDTHxHEIGHT)'
                    }
                },
                required: ['x', 'y']
            }
...

    {
        ...
        function: {
            name: 'getCanvasState',
            description: 'Get all shapes currently on the canvas with their full properties. Use this before manipulating existing shapes.',
            parameters: {
                type: 'object',
                properties: {},
                required: []
